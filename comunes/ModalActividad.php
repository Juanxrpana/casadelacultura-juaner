      ...
      <div class="modal-body">
        ...
        <!--formulario-->
          <form id="frminsertActividad" class="formulario" action="" method="POST">
             ...
             <!-- Cédula encargado  -->
             <div class="formulario__grupo"  id="grupo__responsable_RCedula">
              <label for="responsable_RCedula" class="formulario__label">Cedula del responsable de la Actividad</label>
                <div class="formulario__grupo-input">
                <input class="form-control" name="responsable_RCedula" id="responsable_RCedula"></input>
              ...
              <div class="formulario__grupo"  id="grupo__Salon_idSalon">
              <label for="Salon_idSalon" class="formulario__label">Salon  de la Actividad</label>
                <div class="formulario__grupo-input">
                  <select class="form-control" name="Salon_idSalon" id="Salon_idSalon"></select>                  
                  <i class="formulario__validacion-estado fa-solid fa-xmark"></i>
                </div>
