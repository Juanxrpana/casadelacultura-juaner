...
<!-- Modal -->
<div class="modal fade" id="insertarModalSalon" tabindex="-1" role="dialog" aria-labelledby="insertarModalSalonLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="insertarModalSalon1">Agregar nuevo registro</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
          <form id="frminsertsalon" onsubmit="return insertarDatos()" method="post">
              <label>Cédula</label>
